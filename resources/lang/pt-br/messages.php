...
return [
    ...
    */
    ...
    'credit_error' => 'Você não tem saldo suficiente para criar novos trabalhos!',
    'credit_generate_blockchain_error' => 'Você não tem saldo suficiente para gerar um Copyright Blockchain!',
    ...
    'crud' => [
	    'M'    => [
		    ...
		    'CANCEL'          => [
			    'SUCCESS'      => ':name cancelado!',
			    'SUCCESS-MANY' => ':name cancelados!',
			    'ERROR'        => 'Falha ao cancelar o :name, tente novamente.',
			    'ERROR-MANY'   => 'Falha ao cancelar os :name, tente novamente.',
		    ],
		    //SEARCH
		    'SEARCH'          => [
	    ...
	    'F'    => [
		    ...
		    //CANCEL
		    'CANCEL'          => [
			    'SUCCESS'      => ':name cancelada!',
			    'SUCCESS-MANY' => ':name canceladas!',
			    'ERROR'        => 'Falha ao cancelar a :name, tente novamente.',
			    'ERROR-MANY'   => 'Falha ao cancelar as :name, tente novamente.',
		    ],
		    //SEARCH
		    'SEARCH' => [
