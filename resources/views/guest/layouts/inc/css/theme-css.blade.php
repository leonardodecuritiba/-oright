...
*/
    ...
    .loading {
        background-image: -webkit-linear-gradient(-45deg, #514a9d 0%, #24c6dc 100%);
        background-image: -o-linear-gradient(-45deg, #514a9d 0%, #24c6dc 100%);
        background-image: -moz-linear-gradient(-45deg, #514a9d 0%, #24c6dc 100%);
        background-image: linear-gradient(-45deg, #514a9d 0%, #24c6dc 100%);
    }
    ...
    .team__style-2 .team-member .member-info {
        background: rgba(81, 74, 157, 0.75);
        background-image: -webkit-linear-gradient(-45deg, rgba(81, 74, 157, 0.75) 0%, rgba(36, 198, 220, 0.75) 100%);
        background-image: -o-linear-gradient(-45deg, rgba(81, 74, 157, 0.75) 0%, rgba(36, 198, 220, 0.75) 100%);
        background-image: -moz-linear-gradient(-45deg, rgba(81, 74, 157, 0.75) 0%, rgba(36, 198, 220, 0.75) 100%);
        background-image: linear-gradient(-45deg, rgba(81, 74, 157, 0.75) 0%, rgba(36, 198, 220, 0.75) 100%);
    }

    .section-title.style-gradient > span:after {
        background-image: -webkit-linear-gradient(-45deg, #514a9d 0%, rgba(135, 165, 255, 0.3) 100%);
        background-image: -o-linear-gradient(-45deg, #514a9d 0%, rgba(135, 165, 255, 0.3) 100%);
        background-image: -moz-linear-gradient(-45deg, #514a9d 0%, rgba(135, 165, 255, 0.3) 100%);
        background-image: linear-gradient(-45deg, #514a9d 0%, rgba(135, 165, 255, 0.3) 100%);
    }

    .section-title.style-gradient > span:before {
        background-image: -webkit-linear-gradient(-45deg, #24c6dc 0%, rgba(189, 144, 255, 0.3) 100%);
        background-image: -o-linear-gradient(-45deg, #24c6dc 0%, rgba(189, 144, 255, 0.3) 100%);
        background-image: -moz-linear-gradient(-45deg, #24c6dc 0%, rgba(189, 144, 255, 0.3) 100%);
        background-image: linear-gradient(-45deg, #24c6dc 0%, rgba(189, 144, 255, 0.3) 100%);
    }

    .section-title.style-gradient > span > span {
        border-image: 1 linear-gradient(-45deg, #514a9d 0%, #24c6dc 100%);
    }
    ...
    .contact .contact-form:before {
        background-image: -webkit-linear-gradient(-45deg, rgba(255, 95, 109, 0.2) 0%, rgba(255, 195, 113, 0.2) 100%);
        background-image: -o-linear-gradient(-45deg, rgba(255, 95, 109, 0.2) 0%, rgba(255, 195, 113, 0.2) 100%);
        background-image: -moz-linear-gradient(-45deg, rgba(255, 95, 109, 0.2) 0%, rgba(255, 195, 113, 0.2) 100%);
        background-image: linear-gradient(-45deg, rgba(255, 95, 109, 0.2) 0%, rgba(255, 195, 113, 0.2) 100%);
    }

    /*linear-gradient(to right, #514a9d, #24c6dc);*/
</style>