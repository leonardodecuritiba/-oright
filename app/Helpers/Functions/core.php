...
/**
 * ClassiFácil
 * Copyright (c) duo2. All Rights Reserved
 *
 * Website: http://www.duomidia.com.br
 *
 * LICENSE
 * -------
...
{
    $lang = get_lang();
    $locale = (isset($lang) and !$lang->isEmpty()) ? $lang->get('locale') : 'pt_BR';
...
function getUrlPageByType($type, $locale = null)
{
    ...
    $page = \App\Larapen\Models\Page::type($type)->where('translation_lang', $locale);
    if ($page->count() > 0) {
